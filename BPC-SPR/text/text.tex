...
% TODO Co je SK? Nikde to tu není definováno. => Slovenska Republika :D
...
Autorské právo rozlišuje \textbf{osobnostní a~majetková práva}. Do~osobnostních spadá možnost rozhodnout o~zveřejnění díla, osobovat si autorství či rozhodnout o~nedotknutelnosti díla. Autor se nemůže vzdát osobnostních práv, jelikož jsou nepřeveditelná. Do~majetkových práv spadá rozhodnutí o~užití díla (rozmnožení, rozšiřovaní, pronájem, půjčovaní aj.). V~Česku nelze majetková práva převést translativně, připuštěno je pouze jejich převedení prostřednictvím licenční smlouvy%
\footnote{Autor majetková práva propůjčuje druhé osobě a~má povinnost strpět jejich výkon jinou osobu a~v~případě výhradní licence i~povinnost zdržet se jejich výkonu.}%
. Osobnostní jsou popsána v~\href{https://www.zakonyprolidi.cz/cs/2000-121#p11}{§11~AZ} a~majetková \href{https://www.zakonyprolidi.cz/cs/2000-121#p12}{§12~AZ}, kdy jsou v~dalších paragrafech popsány jednotlivé typy užití.
...
\begin{table}[ht]
	...
	\begin{tabular}{c|c}
		...
		zaniká 70 let po~smrti autora & vydává se na~určitou dobu \\
		                              & (pět let s~možností prodloužení až na~dvacet) \\
...
Z~majetkových práv je při~pohledu na~software asi nejdůležitější právo dílo užívat, kdy se nejspíše nevyužije právo na~vystavování a~sdělován. Do~sdělovaní spadá zejména rozhlas a~televize.
...
\href{https://www.zakonyprolidi.cz/cs/2000-121#p59}{§59~AZ}. Na~kolektivním díle se podílí skupina autorů a~je vytvářeno z~podnětu a~pod vedením fyzické nebo právnické osoby. Toto dílo je poté uváděno na~veřejnost pod~jejím jménem a~příspěvky do~takového díla nelze samostatně užít. Nejčastěji se jedná o~zaměstnanecká díla i~jestliže byla vytvořena na~objednávku. Při vytvoření na~objednávku se na~tato díla nevztahuje \href{https://www.zakonyprolidi.cz/cs/2000-121#p61}{§61}. Dílo audiovizuální a~díla audiovizuálně užitá nejsou dílem kolektivním.
...
Databázi lze definovat jako \emph{\uv{vnitřně organizované soubory informací, údajů, dat, tedy soubory poznatků o~jakýkoliv~skutečnostech}}. Není rozhodující obsah ani rozsah databáze ale existence její vnitřní struktury.
...
Autorskoprávní ochrana chrání databázi pouze jako dílo souborné, tj.~jeho strukturu a~ne~obsah. Pomocí zvláštního práva pořizovatele je chráněn obsah po~dobu 15 let od~doby vzniku nebo prvního zpřístupnění.
